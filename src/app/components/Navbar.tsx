      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-4">
            <Link href="/" className="text-white hover:bg-blue-700 px-3 py-2 rounded-md text-lg">
              Home
            </Link>
            <Link href="/posts" className="text-white hover:bg-blue-700 px-3 py-2 rounded-md text-lg">
              Blog
            </Link>
