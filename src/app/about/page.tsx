      ...
      <section className="bg-lightBlue text-navyBlue py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-6">
            Discover our mission, vision, and the dedicated team behind Tech Insights.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 text-navyBlue">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-4">
            At BlogApp, we aim to create a platform for sharing knowledge, inspiring creativity, and fostering community.
          </p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 duration-300">
                ...
                />
                <div className="p-6 text-navyBlue">
